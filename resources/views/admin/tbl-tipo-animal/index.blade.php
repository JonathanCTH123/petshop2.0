...
@section('title', trans('admin.tbl-tipo-animal.actions.index'))

@section('body')

    <tbl-tipo-animal-listing :data="{{ $data->toJson() }}" :url="'{{ url('admin/tbl-tipo-animals') }}'" inline-template>

        <div class="row">
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> {{ trans('admin.tbl-tipo-animal.actions.index') }}
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0"
                            href="{{ url('admin/tbl-tipo-animals/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp;
                            {{ trans('admin.tbl-tipo-animal.actions.create') }}</a>
                    </div>
                    <div class="card-body" v-cloak>
                        <div class="card-block">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'id'">
                                            {{ trans('admin.tbl-tipo-animal.columns.id') }}</th>
                                        <th is='sortable' :column="'nombre'">
                                            {{ trans('admin.tbl-tipo-animal.columns.nombre') }}</th>
                                        <th is='sortable' :column="'habilitado'">
                                            {{ trans('admin.tbl-tipo-animal.columns.habilitado') }}</th>
                                        ...
                                        <td class="bg-bulk-info d-table-cell text-center" colspan="5">
                                            <span
                                                ...
                                                @{{ clickedBulkItemsCount }}. <a href="#" class="text-primary"
                                                    @click="onBulkItemsClickedAll('/admin/tbl-tipo-animals')"
                                            ...
                                            <span class="pull-right pr-2">
                                                <button class="btn btn-sm btn-danger pr-3 pl-3"
                                                    @click="bulkDelete('/admin/tbl-tipo-animals/bulk-destroy')">{{ trans('brackets/admin-ui::admin.btn.delete') }}</button>
                                            </span>
                            ...
                            <div class="no-items-found" v-if="!collection.length > 0">
                                ...
                                <a class="btn btn-primary btn-spinner" href="{{ url('admin/tbl-tipo-animals/create') }}"
