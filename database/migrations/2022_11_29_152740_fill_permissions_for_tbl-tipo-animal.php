...
class FillPermissionsForTblTipoAnimal extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTblTipoAnimal constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.tbl-tipo-animal',
            'admin.tbl-tipo-animal.index',
            'admin.tbl-tipo-animal.create',
            'admin.tbl-tipo-animal.show',
            'admin.tbl-tipo-animal.edit',
            'admin.tbl-tipo-animal.delete',
            'admin.tbl-tipo-animal.bulk-delete',
        ]);
