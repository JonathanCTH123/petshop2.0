...
class FillPermissionsForTblFacturaDetalle extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTblFacturaDetalle constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.tbl-factura-detalle',
            'admin.tbl-factura-detalle.index',
            'admin.tbl-factura-detalle.create',
            'admin.tbl-factura-detalle.show',
            'admin.tbl-factura-detalle.edit',
            'admin.tbl-factura-detalle.delete',
            'admin.tbl-factura-detalle.bulk-delete',
        ]);
