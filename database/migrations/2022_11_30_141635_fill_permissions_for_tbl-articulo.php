...
class FillPermissionsForTblArticulo extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTblArticulo constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.tbl-articulo',
            'admin.tbl-articulo.index',
            'admin.tbl-articulo.create',
            'admin.tbl-articulo.show',
            'admin.tbl-articulo.edit',
            'admin.tbl-articulo.delete',
            'admin.tbl-articulo.bulk-delete',
        ]);
