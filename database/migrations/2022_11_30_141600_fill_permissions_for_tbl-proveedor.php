...
class FillPermissionsForTblProveedor extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTblProveedor constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.tbl-proveedor',
            'admin.tbl-proveedor.index',
            'admin.tbl-proveedor.create',
            'admin.tbl-proveedor.show',
            'admin.tbl-proveedor.edit',
            'admin.tbl-proveedor.delete',
            'admin.tbl-proveedor.bulk-delete',
        ]);
