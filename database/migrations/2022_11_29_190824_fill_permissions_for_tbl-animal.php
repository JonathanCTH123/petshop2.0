...
class FillPermissionsForTblAnimal extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTblAnimal constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.tbl-animal',
            'admin.tbl-animal.index',
            'admin.tbl-animal.create',
            'admin.tbl-animal.show',
            'admin.tbl-animal.edit',
            'admin.tbl-animal.delete',
            'admin.tbl-animal.bulk-delete',
        ]);
