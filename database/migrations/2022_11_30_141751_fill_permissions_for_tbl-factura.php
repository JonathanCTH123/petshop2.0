...
class FillPermissionsForTblFactura extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTblFactura constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.tbl-factura',
            'admin.tbl-factura.index',
            'admin.tbl-factura.create',
            'admin.tbl-factura.show',
            'admin.tbl-factura.edit',
            'admin.tbl-factura.delete',
            'admin.tbl-factura.bulk-delete',
        ]);
