...
class FillPermissionsForTblCliente extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTblCliente constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.tbl-cliente',
            'admin.tbl-cliente.index',
            'admin.tbl-cliente.create',
            'admin.tbl-cliente.show',
            'admin.tbl-cliente.edit',
            'admin.tbl-cliente.delete',
            'admin.tbl-cliente.bulk-delete',
        ]);
